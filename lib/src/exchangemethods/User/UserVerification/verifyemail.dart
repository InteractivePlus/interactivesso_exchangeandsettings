...
ExchangeFormat<ExchangedVerificationCodeRequiredRequest,void,void,Map<String,dynamic>,void,void> verifyUserEmailAPI = ExchangeFormat(
  ...
  httpMetaData: const ExchangeHTTPMetaData(
    ...
    relativePathWithParameterMarkedWithLtAndGtSymbols: '/user/<vericode_user_unique_id>/verifyEmailResult'
  ), 
